...
<form class="popup" enctype="multipart/form-data" id="addKategorie" method="post" action="index.php?aktion=saveKategorie">
    ...
    <legend class="popup-legend"><h1 id="kategorie-title">Kategorie erstellen</h1></legend>
      <div class="flex">
        <label class="popup-label">Name</label><input id="name-inp" class="input" type="text" name="name"placeholder="Name..."/>
          <label class="popup-label">Name Italienisch</label><input id="name-inp-it" class="input" type="text" name="name-it"placeholder="Name Italienisch..."/>
        <label class="popup-label">Beschreibung</label> <input id="description-inp" class="input" name="description"type="text" placeholder="Beschreibung..."/>
          <label class="popup-label">Beschreibung Italienisch</label> <input id="description-inp-it" class="input" name="description-it"type="text" placeholder="Beschreibung Italienisch..."/>
        ...
        <label class="popup-label">Icon</label><input id="icon-inp" name="icon"class="input" type="file" accept="image/*" placeholder="Icon" required/>
